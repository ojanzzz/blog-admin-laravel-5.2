...
<input type="text" name="name" placeholder="Nama" value="{{old('name')}}" required="required" value="{{ old('name') }}"> 
<input type="email" name="email" placeholder="example@domain.com" value="{{old('email')}}" required="required">
<input type="password" name="password" required="required" placeholder="password"> 
<input type="password" name="password_confirmation" required="required" placeholder="password">
<div class="g-recaptcha" style="margin-bottom:10px;" data-sitekey="{{env('RECAPTCHA_KEY')}}"></div>
<input type="submit" name="login" class="login form-lg-sg-submit" value="Submit">
</form>
