                        ...
                        <div class="panel panel-blue">
                          ...
                          <div class="panel-body panel-category-list">
                            ...
                            @foreach($categories as $category)
                              <li class="todo-list-item" id="todo_list{{$category->id}}">
                                <label>{{$category->name}}</label>
                                <div class="pull-right action-buttons">
                                  <a href="" data-toggle="modal" id="EditCat" data-target="#EditcategoryModal" data-item-id="{{$category->id}}" data-id="{{$category->name}}"><svg class="small-icon glyph stroked pencil"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#stroked-pencil"></use></svg></a>
                                  <button class="destroyCat btn-hidden" value="{{$category->id}}"><svg class="small-icon glyph stroked trash"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#stroked-trash"></use></svg></button>
                                </div>
                              </li>
                              @endforeach
