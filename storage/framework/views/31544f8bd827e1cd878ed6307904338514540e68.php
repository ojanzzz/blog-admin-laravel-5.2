...
<head>
  ...
  <?php echo $__env->make('admin.admin-css', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
</head>

<body>
  <?php echo $__env->make('admin.admin-header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  ...
  <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">     
    ...
    <?php if(Session::has('admin_welcome')): ?>
      <div class="notif">
        <div class="notification">
          <div class="close-and-remove alert bg-primary" role="alert">
            ...
            <?php echo e(Session::get('admin_welcome')); ?> <?php echo e($role->name); ?>
            ...
            <div class="content-break">
              <div class="panel-body">
                <form class="form-horizontal" method="POST" action="/admin/tambah-mbojo-sukses" enctype="multipart/form-data">
                  ...
                  <input type="hidden" name="post_id" value="<?php echo e($role->id); ?>">
                  <input type="hidden" name="author" value="<?php echo e($role->name); ?>">
                  <fieldset>
                      ...
                      <div class="col-md-9">
                        <select class="selected form-control" multiple="multiple" name="category_id[]" id="category_id" required="required">
                          <?php foreach($categories as $category): ?>
                            <option title="<?php echo e($category->name); ?>" id="inputCat<?php echo e($category->id); ?>" value="<?php echo e($category->id); ?>" class="o-multiple"><?php echo e($category->name); ?></option>
                ...
                <?php echo $__env->make('admin.admin-modal', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="row panel_list">
      <div class="col-lg-12 down-animation">
        <div class="panel panel-default card-1">
          ...
          <div class="panel-body">
            <table data-toggle="table" data-url="<?php echo e(url('admin/data-mbojo')); ?>"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
              <thead>
                <tr>
